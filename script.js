const artists = [
    ...
    {name: "Ethan Cohen",          
            ...
            description: "Writing about her work Electrical Walks, Christina Kubisch claimed that 'the technology of the future is invisible, inaudible, wireless'. The hidden technology she sought to reveal was the machinery that permeates both public and private spaces and the imperceptible electromagnetic signals it emits. Sports News Blues is, inversely, an attempt to render audible the life of a technological apparatus that hides in plain sight. Found in gyms, leisure centres, and people’s homes, sports news television is rarely actively watched. It does not lend itself to being listened to with a critical ear. It is reliably and numbingly smooth, inoffensive, and crisp. It is this mild character that allows it to seamlessly hide in its environment. In other words, like architecture, it is so embedded into a space that it can be difficult to stop and ask oneself what values and beliefs it might be expressing. 'The electrical walk is not an event', wrote Kubisch, but 'a slow walk which might reveal what was unknown before'. Sports News Blues is a figurative slow walk through an imagined corridor lined with a series of TVs, each broadcasting sports news. It seeks to uncover and recontextualise its subject by patiently listening from a distance that is both analytical and empathetic. <br><br>'The problem [of listening]', claims Gemma Corradi Fiumara, 'is that of creating sufficient silence to allow ourselves to at least hear the incessant rumbling of our cultural world – a machinery of thought that seems to have lost its original vitality'. This ubiquitous rumbling permeates our cultural life to the point that we now struggle to find the space to question its value. Whereas most digital media seem to be desperate for our constant attention, sports news fulfils an inverse role. It is not designed to be watched compulsively. Unlike social media, or indeed regular news broadcasting, it is not designed to generate an active response in its audience. Rather, it fills the gaps left over by these other media which are laden with a chaotic intensity, nursing our allergy to silence. Its propensity to ‘talk’ constantly attests less to the abrasiveness of culture than the difficulty to find space within it where we can listen and reflect. Peter Szendy asked whether one could listen to the other’s listening; Sports News Blues attempts to invert this question by listening to the others’ not-listening. 'No longer able to hear the noise [our culture] makes', continues Fiumara, 'we nevertheless recognise a desolation that is not so much the deprecated crisis of values, as their inert realisation'. The news reports shown in this montage are a tool used to contain, legitimate, and neutralise this aggression, framing it as rationally encoded, civilised activity. <br> <br>Kubisch’s Electrical Walks listens to technology whose role is strictly utilitarian and functional. By reimagining these objects, these sources of electrical signals, and bringing them to life aesthetically, she quietly subverts the hegemony of these technologies that have colonised our public and private spaces. Sports News Blues takes this reimagination of technology and its role in contemporary life as its starting point and ventures into the world of commercial sports media. What it finds is a domain that is overwhelmingly male: it mostly consists of male reporters talking about sportsmen. It listens to, critiques, and reimagines this domain by detaching them from the sterile, clean fixity to which it is stuck." },
    // {name: "Jiachen Li", 
    //         image: "No Image", 
    //         title: "Untitled", 
    //         description: "No Description" },
